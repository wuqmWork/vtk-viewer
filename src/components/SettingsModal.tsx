            ...
            {page === 'about' && <>
              ...
              <div className="about-card"><div className="about-title">VTK Viewer</div><div className="about-subtitle">{t('toolDesc')}</div>
                <dl className="about-list">
                  <div><dt>{t('version')}</dt><dd>1.0.0</dd></div><div><dt>{t('desktop')}</dt><dd>Tauri 2</dd></div><div><dt>{t('frontend')}</dt><dd>React + TypeScript</dd></div><div><dt>{t('icons')}</dt><dd>Lucide React</dd></div><div><dt>{t('core')}</dt><dd>Rust</dd></div><div><dt>{t('vtkRender')}</dt><dd>vtk.js</dd></div>
                </dl>
              </div>
            </>}
          </section>
