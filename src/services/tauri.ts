...
import type { DatasetInfo, GalvoLayoutInfo } from '../types'
...
export async function getGalvoLayout(): Promise<GalvoLayoutInfo[]> {
  return invoke<GalvoLayoutInfo[]>('get_galvo_layout')
}
